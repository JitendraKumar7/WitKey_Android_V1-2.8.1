...
public class AccountSummaryAdapter extends RecyclerView.Adapter {
    ...
    private List<AccountSummaryBO> dataSet;
    Context mContext;
    int total_types;
    ...
    //constructor...
    public AccountSummaryAdapter(List<AccountSummaryBO> data, Context context, RecyclerView mRecyclerView) {
        this.dataSet = data;
    ...
    public void addItems(List<AccountSummaryBO> viewersSummaryBOs) {
        dataSet.addAll(viewersSummaryBOs);
        notifyDataSetChanged();
    }

    public List<AccountSummaryBO> getItems() {
        return dataSet;
    }
    ...
    public AccountSummaryBO getItem(int position) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_ITEM:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_account_summary_index, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int listPosition) {
        ...
        try {
            AccountSummaryBO accountSummaryBO = dataSet.get(listPosition);

            if (holder instanceof ItemTypeViewHolder) {
                ItemTypeViewHolder itemTypeViewHolder = (ItemTypeViewHolder) holder;

                itemTypeViewHolder.viewerRankTextView.setText(accountSummaryBO.getCoins_count().intValue() + "");

                Utils.setImageRounded(itemTypeViewHolder.viewerImageView, accountSummaryBO.getUser_details().getProfilePictureUrl(), mContext);
                itemTypeViewHolder.viewerTextView.setText(accountSummaryBO.getUser_details().getUsername());

                itemTypeViewHolder.viewerCashTextView.setText(accountSummaryBO.getWitkey_dollar_count().intValue() + "");
