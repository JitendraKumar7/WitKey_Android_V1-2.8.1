...
public class GiftPanelAdapter extends RecyclerView.Adapter {

    private List<GiftPanelItemBO> dataSet;
    Context mContext;
    int total_types;
    ...
    GiftPanelItemBO giftItemBO;

    Button btnSubmit;

    //constructor...
    public GiftPanelAdapter(List<GiftPanelItemBO> data, Context context, RecyclerView mRecyclerView, BubbleViewAnimation _bubbleViewAnimation, Button btnSubmit) {
        this.dataSet = data;
    ...
    public void refreshSelectedStates() {
    ...
    public void addItems(List<GiftPanelItemBO> giftPanelBOList) {
        dataSet.addAll(giftPanelBOList);
        notifyDataSetChanged();
    }

    public List<GiftPanelItemBO> getItems() {
        return dataSet;
    }
    ...
    public GiftPanelItemBO getItem(int position) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int listPosition) {
        ...
        final GiftPanelItemBO giftPanelBO = dataSet.get(listPosition);
        ...
        if (holder instanceof ItemTypeViewHolder) {
            ...
            itemTypeViewHolder.giftPanelQuantity.setText(((int) price) + "");

            Glide.with(mContext)
                    .load(giftPanelBO.getIcon_url())
                    .fitCenter()
                    .into(itemTypeViewHolder.giftPanelImageView);
...
//            itemTypeViewHolder.giftPanelImageView.setImageResource(giftPanelBO.getLocalImage());
            ...
            if (giftPanelBO.getIs_active() == EnumUtils.GiftLevel.GIFT_STATUS_LOCK) {
...
//                    giftItemBO = giftPanelBO;
                    //setSelectedGiftBO(giftPanelBO);
                    GiftsSlideViewAdapter.giftPanelBO = giftPanelBO;
                    itemTypeViewHolder.giftPanelParentFrame.setBackground(mContext.getResources().getDrawable(R.drawable.view_border));
...
//        GlobalBus.getBus().post(new Events.FragmentToGoLiveUpActivityMessage("Gifts_ID", selectedGiftPanelBO.getId()));
    ...
    private class CallEventBusAsyncTask extends AsyncTask<Object, String, String> {
        ...
        protected String doInBackground(Object... params) {
            GlobalBus.getBus().post(new Events.FragmentToGoLiveUpActivityMessage("Gifts_ID", (String) params[1], (int) params[0], (int) params[2], (int) params[2], "NOT USED", 0/*NOT USED*/));
            return null;
        }
    }

    public GiftPanelItemBO getSelectedGiftBO() {
        return giftItemBO;
    }

    public void setSelectedGiftBO(GiftPanelItemBO giftPanelBO) {
        this.giftItemBO = giftPanelBO;
    }
