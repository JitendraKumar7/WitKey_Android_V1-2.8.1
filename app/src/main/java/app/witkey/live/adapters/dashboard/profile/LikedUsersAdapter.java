...
public class LikedUsersAdapter extends RecyclerView.Adapter {

    private List<LikedUsersBO> dataSet;
    Context mContext;
    int total_types;
    ...
    //constructor...
    public LikedUsersAdapter(List<LikedUsersBO> data, Context context, RecyclerView mRecyclerView) {
        this.dataSet = data;
    ...
    public void addItems(List<LikedUsersBO> fanBOList) {
        dataSet.addAll(fanBOList);
        notifyDataSetChanged();
    }

    public List<LikedUsersBO> getItems() {
        return dataSet;
    }
    ...
    public LikedUsersBO getItem(int position) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_ITEM:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_liked_user_item, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int listPosition) {
        ...
        LikedUsersBO fanBO = dataSet.get(listPosition);
...
//            itemTypeViewHolder.timeTextView.setText(Utils.getDifBtwn2Dates(mContext, fanBO.getCreated_at()));
            ...
            if (userBO != null) {
                if ((fanBO.getUser_id() + "").equals(userBO.getId()) || fanBO.getUser_details().getIsArtist() == 0) {
