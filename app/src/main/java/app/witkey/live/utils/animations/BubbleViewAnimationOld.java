...
public class BubbleViewAnimationOld extends View {
    ...
    public BubbleViewAnimationOld(Context context) {
        super(context);
        init();
    }

    public BubbleViewAnimationOld(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public BubbleViewAnimationOld(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public interface AnimationListener {
         ...
         */
        void onAnimationStart(BubbleViewAnimationOld bubbleView);

        /**
         * <p>Notifies the end of the animation. This callback is not invoked
         * for animations with repeat count set to INFINITE.</p>
         */
        void onAnimationEnd(BubbleViewAnimationOld bubbleView);
