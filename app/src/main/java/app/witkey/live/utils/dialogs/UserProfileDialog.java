...
public class UserProfileDialog extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View bottomSheetView = View.inflate(getContext(), R.layout.dialog_user_profile, null);
