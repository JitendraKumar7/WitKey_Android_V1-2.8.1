...
public class UserProfileBottomSheetFragment extends BaseFragment implements View.OnClickListener, MyProfileAdapter.ClickListeners {

    @BindView(R.id.relativeLayoutSweetSheet)
    RelativeLayout relativeLayoutSweetSheet;
    ...
    public static UserProfileBottomSheetFragment newInstance() {
        Bundle args = new Bundle();
        UserProfileBottomSheetFragment fragment = new UserProfileBottomSheetFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_my_profile_bottom_sheet, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        SweetSheet sweetSheet = new SweetSheet(relativeLayoutSweetSheet);
        ...
        View view1 = LayoutInflater.from(getContext()).inflate(R.layout.dialog_user_profile, null, false);
        customDelegate.setCustomView(view1);
        sweetSheet.setDelegate(customDelegate);
        userLevelBoxParentFrame = (RelativeLayout) view1.findViewById(R.id.userLevelBoxParentFrame);
        userLevelBoxTextView = (CustomTextView) view1.findViewById(R.id.userLevelBoxTextView);
        diamondBoxParentFrame = (RelativeLayout) view1.findViewById(R.id.diamondBoxParentFrame);
        diamondsCountBoxTextView = (CustomTextView) view1.findViewById(R.id.diamondsCountBoxTextView);
        momentsProfileToggleParentFrame = (RadioGroup) view1.findViewById(R.id.momentsProfileToggleParentFrame);

        momentsParentFrame = (RelativeLayout) view1.findViewById(R.id.momentsParentFrame);
        momentsRecyclerView = (RecyclerView) view1.findViewById(R.id.momentsRecyclerView);
        noMomentsParentFrame = (RelativeLayout) view1.findViewById(R.id.noMomentsParentFrame);
        profileParentFrame = (RelativeLayout) view1.findViewById(R.id.profileParentFrame);
        profileRecyclerView = (RecyclerView) view1.findViewById(R.id.profileRecyclerView);
...
//        setUpFeaturedRecycler(featuredList);
        ...
        //new UserProfileDialog().show(getActivity().getSupportFragmentManager(), "Option 1");
    }
    ...
    private void populateUserProfileData() {
        ...
        if (userBO != null) {
            ...
            profileIDTextView.setText(userBO.getId());
